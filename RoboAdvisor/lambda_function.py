    ...
    if age is not None:
        ...
        if age < 0 or age > 65:
            return build_validation_result(
                False,
                "age",
                "You should be 0 and 65 years old to use this service, "
    ...
    if investment_amount is not None:
        ...
        if investment_amount <= 5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "The minimum amount to invest should be greater than 5000, "
...
def recommend_portfolio(intent_request):
    ...
    if source == "DialogCodeHook":
        ...
        validation_result = validate_data(first_name=first_name,age=age,investment_amount=investment_amount,intent_request=intent_request)
    ...
    if risk_level == "None":
        ...
        initial_recommendation = "50% bonds (AGG), 50% equities (SPY)"
